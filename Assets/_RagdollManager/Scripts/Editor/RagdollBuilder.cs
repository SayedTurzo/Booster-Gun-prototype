...
namespace MLSpace
{
    public class RagdollBuilder : ScriptableWizard
    {
        ...
        private VoidFunc m_OnWizardCreateCallback = null;
        public VoidFunc OnWizardCreateCallback
        {
            get { return m_OnWizardCreateCallback; }
            set { m_OnWizardCreateCallback = value; }
        }
        ...
        public static RagdollBuilder DisplayWizard()
        {
            RagdollBuilder builder = (RagdollBuilder)DisplayWizard("Create Ragdoll", typeof(RagdollBuilder));
            return builder;
        }
        ...
        void OnWizardCreate()
        {
            ...
            if (m_OnWizardCreateCallback != null)
            {
                m_OnWizardCreateCallback();
            }
        }
